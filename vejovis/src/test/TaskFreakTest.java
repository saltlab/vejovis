...
public class TaskFreakTest {
	...
	static final String JSSOURCEOUTPUTFOLDER = "js_files_taskfreak";
	static final String EXECUTIONTRACEDIRECTORY = "executiontrace/";
	static final String DOMIDLISTSDIRECTORY = "domIdLists/";
	static final String OUTPUTDIRECTORY = "/taskfreak_assertions/";
	static final String INJECTIONSFOLDER = "taskFreakInjections/";
	...
	public static void main(String[] args) {
		...
		String injectModSrc = "";
		URL = "http://192.168.1.84/taskfreak/login.php";
		int numActivations = 150;
		int injStart = 69;
		
		//Redirect System.out to file
		File file = new File("/taskFreakInjections/results_150-10.txt");
	...
	private static void test1() {
		...
		crawler.click("a").withAttribute("href", "javascript:freak_edit(1)");
		crawler.click("a").withAttribute("href", "javascript:freak_edit(2)");
		crawler.click("input").withAttribute("value", "Back to list");
		crawler.click("input").withAttribute("value", "Cancel");
		
		//Login
		InputSpecification input = new InputSpecification();
		input.field("username").setValue("focarizajr");
		input.field("password").setValue("legend");
