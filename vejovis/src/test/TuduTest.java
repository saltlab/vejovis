...
public class TuduTest {
	...
	static final String JSSOURCEOUTPUTFOLDER = "js_files_tudu";
	static final String EXECUTIONTRACEDIRECTORY = "executiontrace/";
	static final String DOMIDLISTSDIRECTORY = "domIdLists/";
	static final String OUTPUTDIRECTORY = "/tudu_assertions/";
	static final String INJECTIONSFOLDER = "tuduInjections/";
	...
	public static void main(String[] args) {
		...
		String injectModSrc = "";
		URL = "http://192.168.1.84:8080/tudu/welcome.action";
		int numActivations = 150;
		int injStart = 0;
		
		//Redirect System.out to file
		File file = new File("/tuduInjections/results_150-1.txt");
	...
	private static void test1() {
		...
		crawler.click("A").withAttribute("href", "javascript:showAddTodo()");
		crawler.click("A").withAttribute("href", "javascript:cancelAddTodo()");
		crawler.click("A").withAttribute("href", "javascript:showAddTodoList()");
		crawler.click("A").withAttribute("href", "javascript:cancelAddTodoList()");
		crawler.click("A").withAttribute("href", "javascript:showEditTodoList()");
		
		//Login
		InputSpecification input = new InputSpecification();
		input.field("j_username").setValue("focarizajr");
		input.field("j_password").setValue("legend");
